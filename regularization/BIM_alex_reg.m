function [eps_BIM, sigma_BIM, error_obj, error_tmp, XX_array] = BIM_alex_reg(freq_num, exp_target_filename, exp_Cal1_filename, exp_Cal2_filename, database_path, reg_path)
